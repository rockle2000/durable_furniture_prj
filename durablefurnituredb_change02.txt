...
CREATE TABLE `cart`  (
  ...
  `ProductPropertiesId` int(11) NOT NULL,
  `Quantity` int(255) NULL DEFAULT NULL,
  `TotalPrice` double(10, 2) NULL DEFAULT NULL,
  PRIMARY KEY (`BillId`, `ProductPropertiesId`) USING BTREE,
  INDEX `ProductPropertiesId`(`ProductPropertiesId`) USING BTREE,
...
-- Records of product
-- ----------------------------
INSERT INTO `product` VALUES (1, 'SanPhamTest', 1, 1, 1, 'OK');
...
CREATE TABLE `productproperties`  (
  `ProductPropertiesId` int(11) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`ProductPropertiesId`) USING BTREE,
  INDEX `ProductId`(`ProductId`) USING BTREE,
  INDEX `ColorId`(`ColorId`) USING BTREE,
  INDEX `SizeId`(`SizeId`) USING BTREE,
  INDEX `MaterialId`(`MaterialId`) USING BTREE,
  INDEX `ProductPropertiesId`(`ProductPropertiesId`) USING BTREE,
  CONSTRAINT `productproperties_ibfk_1` FOREIGN KEY (`ProductId`) REFERENCES `product` (`ProductId`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `productproperties_ibfk_2` FOREIGN KEY (`ColorId`) REFERENCES `color` (`ColorId`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `productproperties_ibfk_3` FOREIGN KEY (`SizeId`) REFERENCES `size` (`SizeId`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `productproperties_ibfk_4` FOREIGN KEY (`MaterialId`) REFERENCES `material` (`MaterialId`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `productproperties_ibfk_5` FOREIGN KEY (`ProductPropertiesId`) REFERENCES `cart` (`ProductPropertiesId`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
